...
export const interiorsPageDefaults: InteriorsPageContentData = {
  ...
  stats: [
    { id: 'time-saved', value: '16h/wk', label: 'Time saved per designer' },
    { id: 'images-rendered', value: '120K+', label: 'Images rendered' },
    { id: 'first-concept', value: '< 5 min', label: 'To first concept' },
    { id: 'designers', value: '5,000+', label: 'Designers & studios' },
  ],
  featuredQuote: {
    quote:
