...
const socialIcons = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/dxlivingaustralia',
    icon: (
  ...
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/company/108389291',
    icon: (
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/dxliving.au/',
    icon: (
  ...
  {
    name: 'YouTube',
    href: 'https://www.youtube.com/@DXLivingofficial',
    icon: (
      <svg className="block h-3.5 w-3.5 shrink-0" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
    ...
    <footer className="bg-[#2A3040] text-slate-200 px-4 lg:px-10" aria-label="Footer">
        ...
        <div className="flex w-full flex-1 flex-wrap items-start justify-center gap-x-6 gap-y-8 sm:gap-x-10 lg:flex-nowrap lg:justify-between lg:gap-x-8 xl:gap-x-12 max-w-[300px] mx-auto md:max-w-[820px]">
          ...
          <div className="w-[calc(50%-0.75rem)] sm:w-auto">
            ...
            <ul className="space-y-2.5 text-[13px] text-[#6A758C] sm:space-y-3 sm:text-[14px]">
              <li>
                <a
                  href="mailto:sales@dxinteriors.ai"
                  className="break-all transition-colors hover:text-white"
                >
                  sales@dxinteriors.ai
                </a>
              </li>
              <li>
                <a href="tel:1800333539" className="transition-colors hover:text-white">
                  1800 333 539
                </a>
              </li>
      ...
      <div className="border-t border-slate-500/30">
        <div className="mx-auto flex max-w-[1380px]  gap-3 px-4 py-4 text-[10px] tracking-[0.12em] text-slate-400 uppercase sm:px-6 sm:text-[11px] flex-col sm:flex-row md:flex-col lg:flex-row sm:items-center sm:justify-between lg:px-10">
          <p className="text-center md:text-left text-[#EAEAEA]">© 2026 DX Living. All rights reserved</p>
          <div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-2 sm:gap-6">
            <Link href="/terms-of-service" className="text-[#6A758C] transition-colors hover:text-slate-200">
              Terms &amp; Conditions
            </Link>
            <Link href="/privacy-policy" className="text-[#6A758C] transition-colors hover:text-slate-200">
              Privacy Policy
            </Link>
            <Link href="#" className="text-[#6A758C] transition-colors hover:text-slate-200">
              User Agreement
            </Link>
          </div>
        </div>
