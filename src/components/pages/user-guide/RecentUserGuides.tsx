...
import type { UserGuideCard } from '@/lib/user-guide/types'

interface RecentUserGuidesProps {
...
export default function RecentUserGuides({ guides }: RecentUserGuidesProps) {
          ...
          {guides.map((guide) => (
            ...
            >
              ...
              <div className="mt-[-15px] flex flex-col p-3 pt-7 sm:p-4 sm:pt-8">
                <h3 className="lao-mn text-[20px] leading-tight text-[#2A3040] sm:text-[22px] md:text-[24px]">
                  {guide.title}
                </h3>
